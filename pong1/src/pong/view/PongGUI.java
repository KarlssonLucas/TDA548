...
public class PongGUI extends Application implements IEventHandler {
    ...
    private void newGame() {
        ...
        // Build the model
        Paddle rightPaddle = new Paddle(0, GAME_HEIGHT / 2, 10, 60, 0);
        Paddle leftPaddle = new Paddle(GAME_WIDTH - PADDLE_WIDTH, GAME_HEIGHT / 2, 10, 60, 0);
        Ball ball = new Ball(GAME_WIDTH/2 - Ball.WIDTH/2, GAME_HEIGHT/2 - Ball.HEIGHT/2, rand.nextInt(4)-2, rand.nextInt(4)-2);
        Ceiling ceiling = new Ceiling(0, 0);
        Floor floor = new Floor(0, GAME_HEIGHT - Floor.FLOOR_HEIGHT, GAME_WIDTH, Floor.FLOOR_HEIGHT);

        // TODO Create objects and connect to a full object model
        pong = new Pong(rightPaddle, leftPaddle, ball, ceiling, floor);
