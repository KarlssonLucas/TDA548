...
public class PongGUI extends Application implements IEventHandler {
    ...
    private void newGame() {
        ...
        // Build the model
        Paddle leftPaddle = new Paddle(PADDLE_WIDTH, GAME_HEIGHT / 2);
        Paddle rightPaddle = new Paddle(GAME_WIDTH - PADDLE_WIDTH*2, GAME_HEIGHT / 2);
        Ball ball = new Ball(GAME_WIDTH/2-BAll_SIZE/2,GAME_HEIGHT/2);

        // TODO Create objects and connect to a full object model

        pong = new Pong(ball,rightPaddle,leftPaddle);
